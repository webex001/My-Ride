...
var ClassnamesGenerator = /** @class */ (function () {
    ...
    function ClassnamesGenerator(parser) {
        ...
        this.generate = function () {
            return {
                regularClassnames: _this._generatedRegularClassnames,
                pseudoClassnames: _this._generatedPseudoClassnames,
            };
        };
        this.isJitModeEnabled = function () { return _this._configParser.getMode() === 'jit'; };
        this.layout = function () {
            var classnames = __assign(__assign({}, nonConfigurableClassNames.layout), { objectPosition: Object.keys(_this._theme.objectPosition).map(function (x) { return 'object-' + x; }), inset: Object.keys(_this._theme.inset).flatMap(function (insetValue) {
            ...
            if (_this.isJitModeEnabled()) {
                return __assign(__assign({}, classnames), { content: Object.keys(_this._theme.content).map(function (x) { return 'content-' + x; }) });
            }
            else {
                return classnames;
            }
        ...
        this.borders = function () {
            var classnames = __assign(__assign({}, nonConfigurableClassNames.borders), { 
                ...
                ringColor: _this.generateClassesWithColors('ringColor'), ringWidth: Object.keys(_this._theme.ringWidth)
                    ...
                    .concat('inset'), ringOpacity: _this.getGeneratedClassesWithOpacities().ringOpacities, ringOffsetColor: _this.generateClassesWithColors('ringOffsetColor'), ringOffsetWidth: Object.keys(_this._theme.ringOffsetWidth).map(function (x) { return 'ring-offset-' + x; }) });
            return _this.isJitModeEnabled()
                ? __assign(__assign({}, classnames), { caretColor: _this.generateClassesWithColors('caretColor') }) : classnames;
        };
        this.tables = function () {
            return nonConfigurableClassNames.tables;
        };
        this.effects = function () {
            return __assign(__assign({}, nonConfigurableClassNames.effects), { boxShadow: Object.keys(_this._theme.boxShadow).map(function (key) { return "shadow-" + key; }), opacity: _this.getGeneratedClassesWithOpacities().opacities });
        };
        ...
        this.interactivity = function () {
            return __assign(__assign({}, nonConfigurableClassNames.interactivity), { cursor: Object.keys(_this._theme.cursor).map(function (x) { return 'cursor-' + x; }), outline: Object.keys(_this._theme.outline).map(function (x) { return 'outline-' + x; }) });
        };
        this.SVG = function () {
        ...
        this.flexBox = function () {
            return __assign(__assign({}, nonConfigurableClassNames.flexBox), { flexGrow: Object.keys(_this._theme.flexGrow).map(function (key) { return "flex-grow-" + key; }), flexShrink: Object.keys(_this._theme.flexShrink).map(function (key) { return "flex-shrink-" + key; }), order: Object.keys(_this._theme.order).map(function (key) { return "order-" + key; }) });
        };
        this.grid = function () {
        ...
        this.typography = function () {
            return __assign(__assign({}, nonConfigurableClassNames.typography), { fontFamily: Object.keys(_this._theme.fontFamily).map(function (value) { return 'font-' + value; }), fontSize: Object.keys(_this._theme.fontSize).map(function (size) { return 'text-' + size; }), fontWeight: Object.keys(_this._theme.fontWeight).map(function (weight) { return 'font-' + weight; }), letterSpacing: Object.keys(_this._theme.letterSpacing).map(function (value) { return 'tracking-' + value; }), lineHeight: Object.keys(_this._theme.lineHeight).map(function (value) { return 'leading-' + value; }), listStyleType: Object.keys(_this._theme.listStyleType).map(function (value) { return 'list-' + value; }), placeholderColor: _this.generateClassesWithColors('placeholderColor'), placeholderOpacity: _this.getGeneratedClassesWithOpacities().placeholderOpacities, textColor: _this.generateClassesWithColors('textColor'), textOpacity: _this.getGeneratedClassesWithOpacities().textOpacities });
        };
        ...
        this.pseudoClasses = function () {
            ...
            var variantsConfig = Object.entries(_.merge(_this._configParser.getVariants(), {
                screenReaders: _this._configParser.getVariants().accessibility,
            }));
            var _loop_1 = function (regularClassGroupKey, pseudoClassesVariantsForKey) {
                ...
                Object.keys(_this._generatedRegularClassnames).map(function (key) {
                    ...
                    if (_.has(_this._generatedRegularClassnames[key], regularClassGroupKey)) {
                        ...
                        generatedClassGroup.map(function (classname) {
                            var isDarkModeEnabled = _this._darkMode !== false;
                            // If JIT compiler mode is enabled...
                            if (_this.isJitModeEnabled()) {
                                // Enable all variants
                            ...
                            pseudoClassesVariantsForKey.map(function (variant) {
                                if (variant === 'responsive') {
                                    // Get the breakpoints from config
                                    var breakpoints = _this._configParser.getThemeProperty('screens')[0];
                                    ...
                                    breakpoints.map(function (breakpointVariant) {
                                        ...
                                        pseudoClasses.push(breakpointVariant + _this._separator + _this._prefix + classname);
                                        ...
                                        if (pseudoClassesVariantsForKey.includes('dark') && isDarkModeEnabled) {
                                            pseudoClasses.push(breakpointVariant +
                                                _this._separator +
                                                'dark' +
                                                _this._separator +
                                                _this._prefix +
                                ...
                                // Otherwise...
                                    ...
                                    if (_this._darkMode === 'class' && !pseudoClasses.includes('dark'))
            ...
            for (var _i = 0, variantsConfig_1 = variantsConfig; _i < variantsConfig_1.length; _i++) {
                var _a = variantsConfig_1[_i], regularClassGroupKey = _a[0], pseudoClassesVariantsForKey = _a[1];
                _loop_1(regularClassGroupKey, pseudoClassesVariantsForKey);
            }
        ...
        this.generateClassesWithColors = function (property) {
            ...
            var classnamesWithColors = propertyKeys
                ...
                if (typeof colorValue === 'object' && colorValue !== null) {
                    ...
                    return Object.keys(colorValue).flatMap(function (shade) {
                        if (utilName === 'border' && _this.isJitModeEnabled()) {
                            return ['', 't', 'r', 'b', 'l'].map(function (side) { return utilName + "-" + (side.length > 0 ? side + '-' : '') + colorName + "-" + shade; });
                        }
                        else {
            ...
            var classnamesWithColorsAndOpacitySuffix = Object.keys(_this._configParser.getTheme().opacity).flatMap(function (op) { return classnamesWithColors.map(function (cls) { return cls + '/' + op; }); });
